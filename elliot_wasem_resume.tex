...
\mysection{Skills}
\textbf{Programming}:\space\space\space Python, Rust, Java, C++, C, Bash, SQL\\
\textbf{Web \& Cloud}:\space\space\space AWS, GCloud, MySQL, PostgreSQL, Docker, Containerization\\
\textbf{Misc. Tech}:\space\space\space\space\space\space Linux, Git, Gitlab, GitHub,
Windows, VSCode, Jira, Confluence, OOP, Agile, CI/CD, Embedded Systems\\

\mysection{Experience}
\textbf{Software Engineer, Platform Developer \href{https://opendrives.com/}{OpenDrives Inc.}},
\textit{Remote} \hfill Dec 2022 --- Present
\begin{itemize}
\item Developing and maintaining a network-attached storage (NAS) system for the Media and Entertainment industry
\item Implementing new features and bug fixes in Python and Rust, with support and infrastructure in Bash
\item Designed and implemented full-system upgrader for Debian-based systems, requiring in-depth knowledge of the whole OS
\item Supported customer support team with in-depth technical knowledge and expertise, enabling them to complete customer requests more quickly
\end{itemize}

\hfill

\textbf{Sr. Assoc., Software Engineer, \href{https://l3harris.com/}{L3Harris Technologies}},
\textit{Clifton, NJ} \hfill Aug 2021 --- Dec 2022
\begin{itemize}
\item Working on embedded radar applications for the US Military
\item Implementing code using C++ for VxWorks operating system on custom hardware
\item Collaborating closely with a cross-discipline team of software, systems, and firmware engineers to solve complex concurrency and inter-processor messaging problems
\item Understanding and making meaningful contributions and changes to enormous legacy code bases
\item Mentoring and providing expertise to less experienced engineers in areas of superior software design principles
\end{itemize}
...
%% \end{itemize}
\mysection{Projects}
\textbf{System Upgrader}, OpenDrives Inc.
\textit{Remote} (Python, Bash)
\begin{itemize}
\item Designed and implemented a full-system upgrader for Debian-based systems
\item Automated PostgreSQL database upgrades, ensuring data integrity and availability
\item Ensured configurations for all services and software were migrated and upgraded correctly (e.g. SMB, NFS, S3, Samba, custom services, to name a few)
\end{itemize}
