...
\mysection{Skills}
\textbf{Programming}:\space\space\space OOP, Java, C++, C, Python, Erlang, Rust, C\#, .NET,
...
\begin{itemize}
\item Taught students Object-Oriented Programming, Operating Systems, Algorithms, Data Structures, and many other topics
\item Became proficient in understanding assignments, coming up with viable solution, and assisting with implementation quickly
\end{itemize}\space
